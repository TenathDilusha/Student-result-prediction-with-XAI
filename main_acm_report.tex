...
\begin{titlepage}
    ...
    % Title at the top
    {\LARGE \bfseries 
    An Explainable AI-Driven Educational Data Mining Framework for Student Academic Performance Prediction Using Optimized Tree-Based Models with SHAP-Based Interpretability
    \par}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[width=1\textwidth]{./images/ai.png}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[width=0.8\textwidth]{images/bar.png}
...
\begin{figure}[htpb]
    ...
    \begin{minipage}{0.45\textwidth}
        ...
        \caption{Distribution of target variable G3}
        \label{fig:xgb}
    \end{minipage}
    \hfill
    \begin{minipage}{0.45\textwidth}
...
\bibitem{ref1}
\href{https://www.sciencedirect.com/science/article/pii/S2772503025000180}{
...
\bibitem{ref2}
\href{https://www.sciencedirect.com/science/article/pii/S2666920X26000093}{
...
\bibitem{ref3}
\href{https://www.nature.com/articles/s41598-025-12353-4}{
W. Ahmed \textit{et al.},
...
\bibitem{ref4}
\href{https://mlhi.org/index.php/main/article/view/29}{
...
\bibitem{ref5}
\href{https://journal.esrgroups.org/jes/article/view/3434}{
T.-H. Tao,
...
\bibitem{ref6}
\href{https://www.mdpi.com/2079-9292/13/21/4157}{
...
\bibitem{ref7}
\href{https://link.springer.com/article/10.1007/s10791-025-09814-9}{
...
\bibitem{ref8}
\href{https://www.sciencedirect.com/science/article/abs/pii/S2214785321042735}{
